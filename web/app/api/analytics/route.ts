...
function calculateFilingSequences(alerts: any[], ticker?: string): FilingSequence[] {
  ...
  byTicker.forEach((tickerAlerts, tickerKey) => {
    // Filter for relevant form types (all registration statements, amendments, prospectus supplements, and current reports)
    const relevantForms = ['S-1', 'S-1/A', 'S-3', 'S-3/A', 'F-1', 'F-1/A', 'F-3', 'F-3/A', 'EFFECT', 'EFFECT-U', '424B1', '424B2', '424B3', '424B4', '424B5', '8-K', '6-K', 'POS AM'];
